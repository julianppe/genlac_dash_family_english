...
dash.register_page(__name__,
                   path='/early-pregnancy',  # represents the url text
                   name='Early pregnancy',  # name of page, commonly used as name of link
                   title='Early pregnancy'  # epresents the title of browser's tab
)
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Women/men ratio', id='page27-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
